...
-- ----------------------------
-- Table structure for t_auditoria_accesos
-- ----------------------------
DROP TABLE IF EXISTS `t_auditoria_accesos`;
CREATE TABLE `t_auditoria_accesos`  (
  `id_Acceso` bigint(20) NOT NULL,
  `id_TipoAcceso` int(11) NOT NULL,
  `fecha_alta` date NOT NULL,
  `id_Empleado` int(11) NOT NULL,
  `estado_Acceso` char(1) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for t_baja_usuarios
-- ----------------------------
DROP TABLE IF EXISTS `t_baja_usuarios`;
CREATE TABLE `t_baja_usuarios`  (
...
-- ----------------------------
-- Table structure for t_nuevo_empleado
-- ----------------------------
DROP TABLE IF EXISTS `t_nuevo_empleado`;
CREATE TABLE `t_nuevo_empleado`  (
